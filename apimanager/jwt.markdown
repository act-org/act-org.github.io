...
The API Manager issued token contains:

1. Token expiration time 
1. Username that is subscribed to the API (typically the app developer) 
1. Application name, id and tier through which API invocation is done 
1. Context of the API
1. API version 
